...
(function($){                               // anonymous function wrapper
    $.fn.extend({                           // attach new method to jQuery
        scale: function(arg1, arg2, arg3){  // declare plugin name/parameters
            ...
            return this.each(function(){
                ...
                if(obj.attr('src') && 
                    ...
                    safelog( "jquery.scale: img src changed to " + newsrc + 
                        " to force a reload");
					// For I.E. 6-8 support as it requires a new image for 
                    // scaling (see issue #3)
                ...
                function scale(){
                    ...
                    // Object too short and skinny. If "stretch" option 
                    // enabled, match the dimenstion that is closer to being
                    // correct.
                    else if(obj.outerWidth() < obj.parent().width() && 
                            obj.outerHeight() < obj.parent().height() &&
                            stretch){
